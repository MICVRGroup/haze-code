...
class load_data():
    def __init__(self, dir='/share/home/zhangyujie/yundata/1',
                 date_begin='20100711',
                 date_end='20100712',
                 time_begin='0600',
                 time_end='2000',
    ...
    def read_images(self, file_dir, image_name_pre='CAMS_GTCI_CLOUD_'):
        print("-------------------------------------")
        ...
        for i in range(total_days):  # bian li mei ge wen jian jia
            ...
            tmp_name = []
            print("===============")
            print("文件夹：", time_begin.strftime("%Y%m%d%H%M")[:8])  # 201007110600
            for j in range(total_hours * 60):  # bian li mei ge wen jian jia zhong de tu pian
                ...
                image_dir = os.path.join(file_dir, time_str[:8],
                                         image_name_pre + time_str + '00.JPG')
    ...
    def data_resample(self, ):
        data_x_dir = os.path.join(self.file_dir, 'data')
        images_data_x, num_data_x, image_names_data_x = self.read_images(data_x_dir)
        data_y_dir = os.path.join(self.file_dir, 'true')
        images_data_y, num_data_y, image_names_data_y = self.read_images(data_y_dir, 'CAMS_TCI_CLOUDRESULT_')
